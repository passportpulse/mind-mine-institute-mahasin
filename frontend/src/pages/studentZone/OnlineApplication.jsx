...
const OnlineApplication = () => {
  ...
  const validate = () => {
    ...
    if (!formData.campusInfo.course.trim()) newErrors.course = "Please select or enter a course";
    if (!formData.studentDetails.fullName.trim()) newErrors.fullName = "Full name is required";
  ...
  if (isSubmitted) {
    return (
      <div className="max-w-2xl mx-auto mt-20 text-center p-10 bg-white shadow-2xl rounded-3xl border border-green-100">
        ...
        <p className="mt-4 text-gray-600">Your enrollment for the 2025–26 session has been received successfully. We will contact you soon.</p>
        <button 
        ...
        <form onSubmit={handleSubmit} className="space-y-12">
          ...
          <section>
            <div className="flex items-center mb-6">
                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-indigo-600 text-white text-sm font-bold mr-3">1</span>
                <h3 className="text-xl font-bold text-gray-900">Campus & Course Info</h3>
            </div>

            <div className="grid gap-6 md:grid-cols-2">
              <div className="space-y-1">
                <label className="text-sm font-semibold text-gray-700 ml-1">Campus</label>
                <input
                  type="text"
                  ...
                  onChange={(e) => handleChange("campusInfo", "campus", e.target.value)}
                />
              </div>

              <div className="space-y-1">
                <label className="text-sm font-semibold text-gray-700 ml-1">Campus Location</label>
                <input
                  type="text"
                  placeholder="City/District"
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all outline-none"
                  value={formData.campusInfo.campusLocation}
                  onChange={(e) => handleChange("campusInfo", "campusLocation", e.target.value)}
                />
              </div>
            </div>
            ...
            <div className="mt-6 space-y-1">
              <label className="text-sm font-semibold text-gray-700 ml-1">
                Course Applied For <span className="text-red-500 font-bold">*</span>
              </label>
              <input
                type="text"
                ...
                onChange={(e) => handleChange("campusInfo", "course", e.target.value)}
              />
          ...
          <section>
            <div className="flex items-center mb-6">
                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-indigo-600 text-white text-sm font-bold mr-3">2</span>
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                onChange={(e) => handleChange("studentDetails", "fullName", e.target.value)}
              />
            ...
            <div className="grid gap-6 mt-6 md:grid-cols-3">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) => handleChange("studentDetails", "dob", e.target.value)}
                />
              </div>
              ...
              <div className="space-y-1">
                <label className="text-sm font-semibold text-gray-700 ml-1">Caste</label>
                <input
                  type="text"
                  placeholder="General/OBC/SC/ST"
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none"
                  value={formData.studentDetails.caste}
                  onChange={(e) => handleChange("studentDetails", "caste", e.target.value)}
                />
              </div>
            </div>
            ...
            <div className="grid gap-6 mt-6 md:grid-cols-2">
              <div className="space-y-1">
                <label className="text-sm font-semibold text-gray-700 ml-1">Contact No <span className="text-red-500 font-bold">*</span></label>
                <input
                  type="tel"
                  ...
                  onChange={(e) => handleChange("studentDetails", "contact", e.target.value)}
                />
                {errors.contact && <p className="text-red-500 text-xs mt-1 ml-1">{errors.contact}</p>}
              </div>

              <div className="space-y-1">
                <label className="text-sm font-semibold text-gray-700 ml-1">Email <span className="text-red-500 font-bold">*</span></label>
                <input
                  type="email"
                  ...
                  onChange={(e) => handleChange("studentDetails", "email", e.target.value)}
                />
          ...
          <section>
            <div className="flex items-center mb-6">
                <span className="flex items-center justify-center w-8 h-8 rounded-full bg-indigo-600 text-white text-sm font-bold mr-3">3</span>
            ...
            <div className="grid gap-4 md:grid-cols-3 p-4 bg-gray-50 rounded-2xl mb-6">
              <input
                ...
                onChange={(e) => handleChange("parentDetails", "fatherName", e.target.value)}
              />
              <input
                type="text"
                ...
                onChange={(e) => handleChange("parentDetails", "fatherOccupation", e.target.value)}
              />
              <input
                type="tel"
                ...
                onChange={(e) => handleChange("parentDetails", "fatherPhone", e.target.value)}
              />
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-3 p-4 bg-gray-50 rounded-2xl">
              <input
                ...
                onChange={(e) => handleChange("parentDetails", "motherName", e.target.value)}
              />
              <input
                type="text"
                placeholder="Occupation"
                ...
                onChange={(e) => handleChange("parentDetails", "motherOccupation", e.target.value)}
              />
              <input
                type="tel"
                ...
                onChange={(e) => handleChange("parentDetails", "motherPhone", e.target.value)}
              />
            </div>
          </section>
          ...
          <div className="pt-8 border-t border-gray-100 flex flex-col items-center">
            <button
              ...
              className={`min-w-[250px] inline-flex items-center justify-center px-10 py-4 text-lg font-bold text-white transition-all rounded-full shadow-xl ${
                isSubmitting ? "bg-indigo-400 cursor-not-allowed" : "bg-indigo-600 hover:bg-indigo-700 hover:-translate-y-1 active:scale-95"
              }`}
            >
              {isSubmitting ? (
                <>
            ...
            <p className="mt-4 text-sm text-gray-500 italic">Please review all fields before submitting.</p>
          </div>
        </form>
      </div>
    </div>
